...
!pip install -q streamlit faiss-cpu flaml kagglehub pandas scikit-learn transformers torch nltk gdown pyngrok

# Tạo thư mục 'models' để lưu các file mô hình
!mkdir -p models

# ============================================
# Viết nội dung cho file 'spam_model.py'
# ============================================
...
class HardExampleGenerator:
    ...
    def _init_spam_phrases(self):
        ...
        social_engineering_phrases = [
            ...
            "boss asked me to buy gift cards for office, already did", "john, can you transfer $300 now, emergency",
...
# -----------------
# For use with Streamlit on Google Colab
# -----------------
